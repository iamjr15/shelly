...
function verifyPromptToArtifactChecklist() {
  ...
  requireText(
    audit,
    "latest pass measured CLI max `4.63ms` and daemon max `43.72ms`",
...
function verifyLatestRefresh() {
  ...
  requireText(audit, "`3.29ms`, p95 `4.23ms`, max `4.63ms`", "release audit must record latest CLI desktop performance values");
  requireText(audit, "`40.57ms`, p95 `42.30ms`, max `43.72ms`", "release audit must record latest daemon desktop performance values");
