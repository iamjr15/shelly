...
function verifyPromptToArtifactChecklist() {
  ...
  requireText(
    audit,
    "latest pass measured CLI max `4.11ms` and daemon max `41.58ms`",
...
function verifyLatestRefresh() {
  ...
  requireText(audit, "`3.18ms`, p95 `3.95ms`, max `4.11ms`", "release audit must record latest CLI desktop performance values");
  requireText(audit, "`39.58ms`, p95 `41.37ms`, max `41.58ms`", "release audit must record latest daemon desktop performance values");
