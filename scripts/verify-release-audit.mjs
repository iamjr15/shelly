...
function verifyPromptToArtifactChecklist() {
  ...
  requireText(
    audit,
    "latest pass measured CLI max `4.42ms` and daemon max `48.11ms`",
...
function verifyLatestRefresh() {
  ...
  requireText(audit, "`3.38ms`, p95 `4.30ms`, max `4.42ms`", "release audit must record latest CLI desktop performance values");
  requireText(audit, "`43.05ms`, p95 `47.58ms`, max `48.11ms`", "release audit must record latest daemon desktop performance values");
