...
function verifyDevelopmentDoc(text) {
  ...
  for (const section of [
    ...
    "the npm dispatcher test covers all three alias shapes against the platform-package fallback path",
    "the CLI dispatcher (`fieldwork`/`fw`) and the daemon dispatcher fall back to the matching platform package",
