...
const checks = [
  ...
  ["Android release readiness self-test", node, ["scripts/check-android-release-readiness.mjs", "--self-test"]],
  ...
  ["live testing fw shim scaffold self-test", node, ["scripts/test-live-testing-fw-shim.mjs"]],
  ["live testing pack scaffold self-test", node, ["scripts/test-live-testing-pack.mjs"]],
  ["Android evidence common helper self-test", node, ["scripts/test-android-evidence-common.mjs"]],
  ["Android release evidence pack scaffold self-test", node, ["scripts/test-android-release-evidence-pack.mjs"]],
  ["Android pair-flow evidence verifier self-test", node, ["scripts/test-android-pair-flow-evidence.mjs"]],
  ["Android pair-flow evidence scaffold self-test", node, ["scripts/test-android-pair-flow-scaffold.mjs"]],
  ["Android session-subscription evidence verifier self-test", node, ["scripts/test-android-session-subscription-evidence.mjs"]],
  ["Android session-subscription evidence scaffold self-test", node, ["scripts/test-android-session-subscription-scaffold.mjs"]],
  ["Android terminal attach evidence verifier self-test", node, ["scripts/test-android-terminal-attach-evidence.mjs"]],
  ["Android terminal attach evidence scaffold self-test", node, ["scripts/test-android-terminal-attach-scaffold.mjs"]],
  ["Android resize/detach evidence verifier self-test", node, ["scripts/test-android-resize-detach-evidence.mjs"]],
  ["Android resize/detach evidence scaffold self-test", node, ["scripts/test-android-resize-detach-scaffold.mjs"]],
  ["Android biometric evidence verifier self-test", node, ["scripts/test-android-biometric-evidence.mjs"]],
  ["Android biometric evidence scaffold self-test", node, ["scripts/test-android-biometric-scaffold.mjs"]],
  ["Android dogfood evidence verifier self-test", node, ["scripts/test-android-dogfood-evidence.mjs"]],
  ["Android dogfood evidence scaffold self-test", node, ["scripts/test-android-dogfood-scaffold.mjs"]],
  ["Android cold-start evidence verifier self-test", node, ["scripts/test-android-cold-start-evidence.mjs"]],
  ["Android cold-start evidence scaffold self-test", node, ["scripts/test-android-cold-start-scaffold.mjs"]],
  ["Android release-install evidence verifier self-test", node, ["scripts/test-android-release-install-evidence.mjs"]],
  ["Android release-install evidence scaffold self-test", node, ["scripts/test-android-release-install-scaffold.mjs"]],
  ["Android release-signing evidence verifier self-test", node, ["scripts/test-android-release-signing-evidence.mjs"]],
  ["Android release-signing evidence scaffold self-test", node, ["scripts/test-android-release-signing-scaffold.mjs"]],
  ["Android renderer flood evidence verifier self-test", node, ["scripts/test-android-renderer-flood-evidence.mjs"]],
  ["Android renderer flood evidence scaffold self-test", node, ["scripts/test-android-renderer-flood-scaffold.mjs"]],
  ["Android background/foreground evidence verifier self-test", node, ["scripts/test-android-background-foreground-evidence.mjs"]],
  ["Android background/foreground evidence scaffold self-test", node, ["scripts/test-android-background-foreground-scaffold.mjs"]],
  ["Android network reconnect evidence verifier self-test", node, ["scripts/test-android-network-reconnect-evidence.mjs"]],
  ["Android network reconnect evidence scaffold self-test", node, ["scripts/test-android-network-reconnect-scaffold.mjs"]],
  ["Android restart-restore evidence verifier self-test", node, ["scripts/test-android-restart-restore-evidence.mjs"]],
  ["Android restart-restore evidence scaffold self-test", node, ["scripts/test-android-restart-restore-scaffold.mjs"]],
  ["Android multisession evidence verifier self-test", node, ["scripts/test-android-multisession-evidence.mjs"]],
  ["Android multisession evidence scaffold self-test", node, ["scripts/test-android-multisession-scaffold.mjs"]],
  ["Android FCM push evidence verifier self-test", node, ["scripts/test-android-fcm-push-evidence.mjs"]],
  ["Android FCM push evidence scaffold self-test", node, ["scripts/test-android-fcm-push-scaffold.mjs"]],
  ["relay Honeycomb evidence verifier self-test", node, ["scripts/test-relay-honeycomb-evidence.mjs"]],
  ["relay Honeycomb evidence scaffold self-test", node, ["scripts/test-relay-honeycomb-scaffold.mjs"]],
  ["macOS daemon survival evidence verifier self-test", node, ["scripts/test-macos-daemon-survival-evidence.mjs"]],
  ["macOS daemon survival evidence scaffold self-test", node, ["scripts/test-macos-daemon-survival-scaffold.mjs"]],
  ...
  ["release workflow run-block syntax self-test", node, ["scripts/verify-release-workflows.mjs", "--self-test"]],
  ...
  ["npm release evidence verifier self-test", node, ["scripts/test-npm-release-evidence.mjs"]],
  ["npm release evidence scaffold self-test", node, ["scripts/test-npm-release-scaffold.mjs"]],
  ...
  ["Android debug APK verifier self-test", node, ["scripts/test-android-debug-apk-verifier.mjs"]],
  ...
  ["release artifact evidence verifier self-test", node, ["scripts/test-release-artifacts-evidence.mjs"]],
  ["release artifact evidence scaffold self-test", node, ["scripts/test-release-artifacts-scaffold.mjs"]],
  ["macOS signing verifier self-test", node, ["scripts/test-macos-signing-verifier.mjs"]],
  ["macOS signing evidence verifier self-test", node, ["scripts/test-macos-signing-evidence.mjs"]],
  ["macOS signing evidence scaffold self-test", node, ["scripts/test-macos-signing-scaffold.mjs"]],
...
const artifactChecks = [
  ...
  ["Android debug APK artifact", node, ["scripts/verify-android-debug-apk.mjs"]],
  ["Android AAB local signing smoke", node, ["scripts/test-android-aab-signing-smoke.mjs"]],
  ...
  ["npm local install smoke", node, ["scripts/smoke-npm-local-install.mjs"]],
...
const runtimeChecks = [
  ["CLI doctor smoke", bash, ["scripts/smoke-cli-doctor.sh"], { env: localHandoffEnv() }],
