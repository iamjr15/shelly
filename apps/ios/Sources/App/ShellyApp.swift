    ...
    var body: some Scene {
        WindowGroup {
            RootView()
                ...
                .onReceive(NotificationCenter.default.publisher(for: .shellyDidRegisterApnsToken)) { notification in
                ...
                .onReceive(NotificationCenter.default.publisher(for: .shellyDidReceivePushSessionHash)) { notification in
