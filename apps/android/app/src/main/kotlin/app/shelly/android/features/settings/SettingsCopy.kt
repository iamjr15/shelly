...
internal const val LICENSES_BODY = "Shelly and bundled dependency notices"
internal const val UNPAIR_TITLE = "Unpair this phone?"
internal const val UNPAIR_BODY =
    "This removes Shelly pairing data from this phone. Desktop sessions keep running. " +
        "If the phone is lost, revoke it on your laptop with shelly devices remove <device>."
