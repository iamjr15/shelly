...
- Desktop performance passed after one explicit warm-up sample, with CLI median
  `3.45ms`, p95 `4.35ms`, max `4.38ms`, and daemon ready-to-handshake median
  `40.84ms`, p95 `44.12ms`, max `44.95ms` over 25 measured release-build
