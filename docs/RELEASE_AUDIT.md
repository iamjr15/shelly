...
- Desktop performance passed after one explicit warm-up sample, with CLI median
  `3.92ms`, p95 `18.04ms`, max `29.52ms`, and daemon ready-to-handshake median
  `56.34ms`, p95 `114.34ms`, max `122.43ms` over 25 measured release-build
