...
performance run reported CLI median `3.29ms`, p95 `4.23ms`, max `4.63ms`, and
daemon ready-to-handshake median `40.57ms`, p95 `42.30ms`, max `43.72ms` over
...
- Desktop performance passed after one explicit warm-up sample, with CLI median
  `3.29ms`, p95 `4.23ms`, max `4.63ms`, and daemon ready-to-handshake median
  `40.57ms`, p95 `42.30ms`, max `43.72ms` over 25 measured release-build
  samples.
