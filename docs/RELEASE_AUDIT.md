...
performance run reported CLI median `4.02ms`, p95 `5.09ms`, max `5.25ms`, and
daemon ready-to-handshake median `41.20ms`, p95 `43.79ms`, max `44.62ms` over
...
- Desktop performance passed after one explicit warm-up sample, with CLI median
  `4.02ms`, p95 `5.09ms`, max `5.25ms`, and daemon ready-to-handshake median
  `41.20ms`, p95 `43.79ms`, max `44.62ms` over 25 measured release-build
  samples.
