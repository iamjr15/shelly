...
median `3.33ms`, p95 `4.24ms`, max `4.46ms`, and daemon ready-to-handshake
median `41.03ms`, p95 `45.06ms`, max `48.45ms` over 25 measured release-build
...
- Desktop performance passed after one explicit warm-up sample, with CLI median
  `3.33ms`, p95 `4.24ms`, max `4.46ms`, and daemon ready-to-handshake median
  `41.03ms`, p95 `45.06ms`, max `48.45ms` over 25 measured release-build
  samples.
