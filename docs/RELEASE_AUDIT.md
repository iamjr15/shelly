...
- Desktop performance passed after one explicit warm-up sample, with CLI median
  `3.57ms`, p95 `4.47ms`, max `4.58ms`, and daemon ready-to-handshake median
  `42.37ms`, p95 `47.07ms`, max `49.04ms` over 25 measured release-build
  samples in the latest `pnpm check:local-release -- --with-artifacts --with-runtime`
  run.
