...
- Desktop performance passed after one explicit warm-up sample, with CLI median
  `3.78ms`, p95 `4.43ms`, max `4.47ms`, and daemon ready-to-handshake median
  `41.23ms`, p95 `44.38ms`, max `45.74ms` over 25 measured release-build
