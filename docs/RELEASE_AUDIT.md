...
median `3.47ms`, p95 `4.01ms`, max `4.07ms`, and daemon ready-to-handshake
median `40.60ms`, p95 `43.11ms`, max `44.88ms` over 25 measured release-build
...
- Desktop performance passed after one explicit warm-up sample, with CLI median
  `3.47ms`, p95 `4.01ms`, max `4.07ms`, and daemon ready-to-handshake median
  `40.60ms`, p95 `43.11ms`, max `44.88ms` over 25 measured release-build
  samples.
