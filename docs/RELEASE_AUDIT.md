...
- Desktop performance passed after one explicit warm-up sample, with CLI median
  `3.59ms`, p95 `4.53ms`, max `4.55ms`, and daemon ready-to-handshake median
  `41.42ms`, p95 `44.55ms`, max `45.61ms` over 25 measured release-build
