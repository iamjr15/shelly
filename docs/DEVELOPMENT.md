...
`APPLICATION_ID = "app.fieldwork.android"`, `BUILD_TYPE = "debug"`,
`DEBUG = Boolean.parseBoolean("true")`, `FIELDWORK_BIOMETRIC_BYPASS = false`,
and `FIELDWORK_DEBUG_PAIRING_PAYLOAD = ""`. The screenshot was a 1080x2400 PNG
with SHA-256
